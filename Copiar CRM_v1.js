...
function copySheetsFromSource() {
  try {
    ...
    // Reconstruir el índice de última actividad para asegurar que los datos del Dashboard estén al día
    if (typeof buildUltimaActividadIndex === 'function') {
      console.log('🔄 Iniciando reconstrucción del índice de actividad...');
      buildUltimaActividadIndex();
    }

    console.log('✅ Hojas copiadas e índice actualizado exitosamente: ' + CONFIG.SHEETS_TO_COPY.join(', '));
  } catch (error) {
